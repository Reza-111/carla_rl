    ...
    try:
        ...
        if train:
            ...
            while timestep < total_timesteps:
                ...
                frame_buffer, command_tensor, speed_tensor = env.reset()
                # observation = encode.process(observation)
                observation = (frame_buffer, command_tensor, speed_tensor)
                current_ep_reward = 0
                t1 = datetime.now()
                ...
                for t in range(args.episode_length):
                    ...
                    frame_buffer, command_tensor, speed_tensor, reward, done, info = env.step(action)
                    observation = (frame_buffer, command_tensor, speed_tensor)
